...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/couchdbreceiver v0.42.0
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib v0.42.1-0.20220119193557-f430ca84115a // indirect
