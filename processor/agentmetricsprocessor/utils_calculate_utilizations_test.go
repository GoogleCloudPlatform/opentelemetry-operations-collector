...
func generateUtilizationMetricsInput() pdata.Metrics {
	...
	mb2 := b.addMetric("system.memory.usage", pdata.MetricDataTypeIntSum, false)
	mb2.addIntDataPoint(1, map[string]string{"state": "used"})
	mb2.addIntDataPoint(2, map[string]string{"state": "free"})

	mb3 := b.addMetric("system.filesystem.usage", pdata.MetricDataTypeDoubleSum, true)
...
func generateUtilizationMetricsExpected() pdata.Metrics {
	...
	mb6 := b.addMetric("system.filesystem.utilization", pdata.MetricDataTypeDoubleGauge, false)
