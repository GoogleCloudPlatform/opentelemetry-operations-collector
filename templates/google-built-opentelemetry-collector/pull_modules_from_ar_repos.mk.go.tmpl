...
$(AR_AUTH_BIN): $(GO_BIN)
	...
	GOBIN=$(TOOLS_DIR) GOPROXY=https://us-go.pkg.dev/artifact-foundry-prod/golang-3p-trusted GOSUMDB=off CGO_ENABLED=0 $(GO_BIN) install -trimpath -ldflags="-s -w" github.com/GoogleCloudPlatform/artifact-registry-go-tools/cmd/auth@v0.4.0 ;\
	}
