module github.com/GoogleCloudPlatform/opentelemetry-operations-collector/integration_test/policy_test
...
require (
	...
	go.opentelemetry.io/collector/processor/queuebatchprocessor v0.160.0 // indirect
