...
| `opentelemetry_contrib_stable_version` | string | | The stable version of the OpenTelemetry Collector Contrib repository that this distribution is based off of. It must line up with the `opentelemetry_contrib_version`, i.e. for `0.161.0` of the contrib repository the stable version was `1.0.0`. |
