...
func components() (otelcol.Factories, error) {
	...
	factories.ExtensionModules = makeModulesMap(factories.Extensions, map[component.Type]string{
		healthagent.NewFactory().Type(): "github.com/GoogleCloudPlatform/opentelemetry-operations-collector/components/google-built-opentelemetry-collector/extension/healthagent v0.155.0",
		...
		healthcheckv2extension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/healthcheckv2extension v0.155.0",
	...
	factories.ExporterModules = makeModulesMap(factories.Exporters, map[component.Type]string{
		googleservicecontrolexporter.NewFactory().Type(): "github.com/GoogleCloudPlatform/opentelemetry-operations-collector/components/google-built-opentelemetry-collector/exporter/googleservicecontrolexporter v0.155.0",
