...
type HealthMetric struct {
	...
	Status HealthStatus `protobuf:"varint,2,opt,name=status,proto3,enum=healthagent.HealthStatus" json:"status,omitempty"`
	...
	AggregationTarget AggregationTarget `protobuf:"varint,5,opt,name=aggregation_target,json=aggregationTarget,proto3,enum=healthagent.AggregationTarget" json:"aggregation_target,omitempty"`
...
const file_health_proto_rawDesc = "" +
	...
	"\aTIMEOUT\x10\x032Y\n" +
	"\vHealthAgent\x12J\n" +
	"\tGetHealth\x12\x1d.healthagent.GetHealthRequest\x1a\x1e.healthagent.GetHealthResponseB\x13Z\x11internal/healthpbb\x06proto3"
...
var file_health_proto_goTypes = []any{
	(AggregationTarget)(0),    // 0: healthagent.AggregationTarget
	(HealthStatus)(0),         // 1: healthagent.HealthStatus
	(*HealthMetric)(nil),      // 2: healthagent.HealthMetric
	(*GetHealthRequest)(nil),  // 3: healthagent.GetHealthRequest
	(*GetHealthResponse)(nil), // 4: healthagent.GetHealthResponse
	(*anypb.Any)(nil),         // 5: google.protobuf.Any
}
var file_health_proto_depIdxs = []int32{
	1, // 0: healthagent.HealthMetric.status:type_name -> healthagent.HealthStatus
	5, // 1: healthagent.HealthMetric.details:type_name -> google.protobuf.Any
	0, // 2: healthagent.HealthMetric.aggregation_target:type_name -> healthagent.AggregationTarget
	2, // 3: healthagent.GetHealthResponse.health_metrics:type_name -> healthagent.HealthMetric
	3, // 4: healthagent.HealthAgent.GetHealth:input_type -> healthagent.GetHealthRequest
	4, // 5: healthagent.HealthAgent.GetHealth:output_type -> healthagent.GetHealthResponse
