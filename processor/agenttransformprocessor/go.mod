...
replace github.com/open-telemetry/opentelemetry-collector-contrib/processor/transformprocessor v0.121.0 => github.com/franciscovalentecastro/opentelemetry-collector-contrib/processor/transformprocessor v0.121.0-ottl-func
