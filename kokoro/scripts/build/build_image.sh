...
docker buildx build \
--file git/otelcol-google/google-built-opentelemetry-collector/Dockerfile.image_with_gcloud.build \
...
--output=type=oci,dest=$KOKORO_ARTIFACTS_DIR/container.tar .
