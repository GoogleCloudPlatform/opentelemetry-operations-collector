...
mkdir -p dist/prometheus_exporter
...
cp mysqld_exporter/mysqld_exporter dist/prometheus_exporter/mysqld_exporter
...
cp apache_exporter/apache_exporter dist/prometheus_exporter/apache_exporter
...
cp jmx_exporter/jmx_prometheus_httpserver/target/jmx_prometheus_httpserver-${version}-jar-with-dependencies.jar dist/prometheus_exporter/jmx_exporter.jar
rm -rf jmx_exporter
...
cp statsd_exporter/statsd_exporter dist/prometheus_exporter/statsd_exporter
