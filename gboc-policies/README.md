# Google-Built OpenTelemetry Collector Experimental Policies

**THIS DISTRIBUTION IS NOT MEANT FOR PRODUCTION USE**. This is a temporary distribution that contains experimental policy support and is intended for development purposes exclusively.
