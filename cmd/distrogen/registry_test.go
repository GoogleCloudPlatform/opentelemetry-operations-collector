...
func TestLoadRegistry(t *testing.T) {
	...
	assert.NilError(t, err)
	assert.Assert(t, registry != nil)
	assert.Assert(t, registry.Components[ReceiverType]["testreceiver"] != nil, "Expected 'testreceiver' to be loaded")
	assert.Equal(t, registry.Components[ReceiverType]["testreceiver"].GoMod.URL, "github.com/test/receiver")
	assert.Assert(t, registry.Components[ProcessorType]["testprocessor"] != nil, "Expected 'testprocessor' to be loaded")
	assert.Equal(t, registry.Components[ProcessorType]["testprocessor"].GoMod.URL, "github.com/test/processor")
	assert.Assert(t, registry.Components[ExporterType]["testexporter"] != nil, "Expected 'testexporter' to be loaded")
	assert.Equal(t, registry.Components[ExporterType]["testexporter"].GoMod.URL, "github.com/test/exporter")
	assert.Assert(t, registry.Components[ConnectorType]["testconnector"] != nil, "Expected 'testconnector' to be loaded")
	assert.Equal(t, registry.Components[ConnectorType]["testconnector"].GoMod.URL, "github.com/test/connector")
	assert.Assert(t, registry.Components[ExtensionType]["testextension"] != nil, "Expected 'testextension' to be loaded")
	assert.Equal(t, registry.Components[ExtensionType]["testextension"].GoMod.URL, "github.com/test/extension")
}
